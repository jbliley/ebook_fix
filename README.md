...
<br>Book Metadata includes every identifier the book carries (ISBN, ASIN, a Calibre UUID, etc.), not just one, with each classified by type where recognizable. It also reports whether the book is being read from inside a Calibre library or as a standalone file.
