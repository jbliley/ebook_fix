...
The project is still under development and currently supports analysis and repair of **EPUB** files, plus converting classic **MOBI** and **FB2** books to EPUB without needing any other software.
...
`ebook_fix` also has a full command-line interface covering analysis, repair, auto-fix, MOBI/FB2 to EPUB conversion, cover replacement, series metadata, file-integrity checks, and configuration, useful for scripting or working through many books at once without the GUI.
